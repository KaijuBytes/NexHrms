...
class TestShiftAssignment(IntegrationTestCase):
	...
	def test_overlapping_for_a_fixed_period_shift_and_ongoing_shift(self):
		employee = make_employee("test_shift_assignment@example.com", agency="_Test Agency")
	...
	def test_calendar(self):
		employee1 = make_employee("test_shift_assignment1@example.com", agency="_Test Agency")
		employee2 = make_employee("test_shift_assignment2@example.com", agency="_Test Agency")
		employee3 = make_employee("test_shift_assignment3@example.com", agency="_Test Agency")
	...
	def test_consecutive_day_and_night_shifts(self):
		# defaults
		employee = make_employee("test_default_shift_assignment@example.com", agency="_Test Agency")
		today = getdate()

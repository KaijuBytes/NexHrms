...
class TestAttendance(IntegrationTestCase):
	...
	def test_duplicate_attendance(self):
		employee = make_employee("test_duplicate_attendance@example.com", agency="_Test Agency")
		date = nowdate()
	...
	def test_overlapping_shift_attendance_validation(self):
		...
		employee = make_employee("test_overlap_attendance@example.com", agency="_Test Agency")
		date = nowdate()
